...
public class ParentController {
    ...
    public String parentList(@RequestParam(name = "currentPage"
              ,defaultValue = "0") int currentPage, @RequestParam(defaultValue = "") String search, Model model, @RequestHeader(value = "X-Requested-With", required = false) String requestedWith, Principal principal) {
    ...
    public String parentDetailsAdmin(@RequestParam(name = "currentPage"
            ,defaultValue = "0") int currentPage, @PathVariable("id") int id, Model model,Principal principal,  @RequestHeader(value = "X-Requested-With", required = false) String requestedWith) {
    ...
    @Transactional
    @PostMapping("school-owner/parent-list/parent-details/{id}")
    public String enrollParentToSchool(@RequestParam(name = "currentPage"
            ,defaultValue = "0") int currentPage, @PathVariable("id") int id, Model model, Principal principal,@RequestParam("school") int schoolId) {
        /*
