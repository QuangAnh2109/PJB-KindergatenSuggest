...
(function($) {
    'use strict';
     ...
     var preloader_custom_image = '/user_side/images/preloader/segments.svg'; // insert image url to enable custom image, off - for disable custom image
     var loading_text = "Loading..."; // text for preloader. If you don't use text just leave it blank
     var loading_text_position = "10px"; // set position for loading text. Default value is 0px
